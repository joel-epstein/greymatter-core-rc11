...
mesh: meshv1.#Mesh & {
	...
	spec: {
		...
		images: {
			...
			control:     string | *"greymatter.jfrog.io/oci/greymatter-control:1.8.9"
			control_api: string | *"greymatter.jfrog.io/oci/greymatter-control-api:1.8.9"
...
defaults: {
	...
	images: {
		cli:               string | *"greymatter.jfrog.io/oci/greymatter-cli:4.7.5"
		operator:          string | *"greymatter.jfrog.io/oci/greymatter-operator:0.16.3" @tag(operator_image)
		vector:            string | *"timberio/vector:0.22.0-debian"
		observables:       string | *"greymatter.jfrog.io/oci/greymatter-audits:1.1.7"
